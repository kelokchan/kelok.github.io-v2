  ...
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        ...
        <SVG icon="hexa" width={48} stroke={colors.blue} left="60%" top="70%" />
      ...
      <UpDownWide>
        ...
        <SVG icon="cross" width={16} stroke={colors.red} left="28%" top="15%" />
      ...
      <SVG icon="circle" width={64} fill={colors.yellow} left="95%" top="5%" />
